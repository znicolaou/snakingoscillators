...
\title{Continuation of oscillatory localized states}
...
\caption{Gap solitons in parametrically-driven pendula.}
\end{figure}
...
\caption{Traveling chimeras in the ring of Janus oscillators.}
\end{figure}
